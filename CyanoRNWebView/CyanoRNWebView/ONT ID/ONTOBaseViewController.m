...
-(void)viewWillAppear:(BOOL)animated{
    ...
    [self.navigationController.navigationBar setBackgroundImage:[EasyShowUtils imageWithColor:[UIColor blackColor]] forBarPosition:UIBarPositionAny barMetrics:UIBarMetricsDefault];
...
-(void)viewWillDisappear:(BOOL)animated
{
    ...
    [self.navigationController.navigationBar setBackgroundImage:[EasyShowUtils imageWithColor:[Common colorWithHexString:@"#3bb4d0"]] forBarPosition:UIBarPositionAny barMetrics:UIBarMetricsDefault];
...
-(void)setNavLeftImageIcon:(UIImage *)imageIcon Title:(NSString *)title{
    ...
    [button setTitleColor:[Common colorWithHexString:@"#565656"] forState:UIControlStateNormal];
...
-(void)setNavRightImageIcon:(UIImage *)imageIcon Title:(NSString *)title{
    ...
    [_rightButton setTitleColor:[Common colorWithHexString:@"#6A797C"] forState:UIControlStateNormal];
    ...
    [_rightButton setImageEdgeInsets:UIEdgeInsetsMake(0, _rightButton.titleLabel.frame.size.width, 0, -_rightButton.titleLabel.frame.size.width)];
