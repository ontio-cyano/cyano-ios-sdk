...
-(void)createUI{
    ...
    *tapGesture = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(hiddenAlert)];
    ...
    _confirmBtn.backgroundColor = [Common colorWithHexString:@"#9B9B9B"];
...
- (void)protocolIsSelect:(BOOL)select {
    ...
    _textview.linkTextAttributes = @{NSForegroundColorAttributeName: [Common colorWithHexString:@"#196BD8"],
