...
-(void)createUI{
    ...
    WhatOntId.textColor = [Common colorWithHexString:@"#6E6F70"];
    ...
    [bottomLB mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        if (ONTOIsiPhone5) {
            ...
            CGFloat h = ONTOHeight - createONTId.frame.origin.y - 60 - 64 - 34 - 50;
            make.top.equalTo(createONTId.mas_bottom).offset(h);
        }else{
            CGFloat h = ONTOHeight - createONTId.frame.origin.y - 60 - 64 - 50;
            make.top.equalTo(createONTId.mas_bottom).offset(h);
        }
