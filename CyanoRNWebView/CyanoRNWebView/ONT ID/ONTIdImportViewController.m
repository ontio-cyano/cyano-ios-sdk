...
-(void)createUI{
    ...
    _textView.backgroundColor = [Common colorWithHexString:@"#F3F3F3"];
    ...
    [whatBtn setTitleColor:[Common colorWithHexString:@"#196BD8"] forState:UIControlStateNormal];
    ...
    _pswField.textColor = [Common colorWithHexString:@"#6E6F70"];
    ...
    line.backgroundColor = [Common colorWithHexString:@"#DDDDDD"];
    ...
    _pswConfirmField.textColor = [Common colorWithHexString:@"#6E6F70"];
    ...
    line1.backgroundColor = [Common colorWithHexString:@"#DDDDDD"];
    ...
    _importBtn.backgroundColor = [Common colorWithHexString:@"#9B9B9B"];
    ...
    [_importBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        if (ONTOIsiPhone5) {
            ...
            CGFloat h = ONTOHeight - self.sureBtn.frame.origin.y - 22 - 88 - 34 - 100;
            make.top.equalTo(self.sureBtn.mas_bottom).offset(h);
        }else{
            CGFloat h = ONTOHeight - self.sureBtn.frame.origin.y - 22 - 64 -100;
            make.top.equalTo(self.sureBtn.mas_bottom).offset(h);
        }
...
- (void)protocolIsSelect:(BOOL)select {
    ...
    _infotextview.linkTextAttributes = @{NSForegroundColorAttributeName: [Common colorWithHexString:@"#196BD8"],
                                     NSUnderlineColorAttributeName: [Common colorWithHexString:@"#AAB3B4"],
...
- (BOOL)textView:(UITextView *)textView shouldInteractWithURL:(NSURL *)URL inRange:(NSRange)characterRange {
    ...
    if ([[URL scheme] isEqualToString:@"Terms"]) {
        ONTOWebViewController * vc = [[ONTOWebViewController alloc]init];
